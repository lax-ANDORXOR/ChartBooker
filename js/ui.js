    ...
    playersList.forEach(p => {
   	...
   	item.innerHTML = `
            <div class="flex items-center gap-2">
            	...
            	${isHost && !p.isHost ? `<button class="btn btn-xs btn-danger" onclick="confirmKick('${p.id}')" style="margin-left:8px;">✕</button>` : ''}
            </div>
